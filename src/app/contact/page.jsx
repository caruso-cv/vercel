          ...
          <form onSubmit={handleSubmit} method="POST" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-48">
            <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-2.5">
                    <textarea
                      ...
                      name="message"
                      rows={4}
                      className={`block w-full rounded-md bg-white/5 px-3.5 py-2 text-base text-white 3xl:text-base placeholder:text-gray-500 focus:outline-indigo-500 ${errors.message ? 'border border-red-500' : ''}`}
                      required
                    />
              ...
              <div className="mt-8 flex justify-end">
                <button
                  type="submit"
                  className="rounded-md bg-[#425ACA] px-3.5 py-2.5 text-center text-sm font-semibold text-white 3xl:text-base shadow-sm hover:bg-indigo-500 focus:outline-indigo-500 "
                >
                  Send message
                </button>
              </div>
