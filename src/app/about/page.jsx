...
// <motion.div
// className="rounded-4xl absolute top-[100vh] left-[10vw] z-30 max-w-7xl mx-auto bg-gradient-to-t from-[#ffffff] to-white/70 border border-[#f4f4f4] backdrop-blur-[20px]"
// initial={{ y: 20 }}
// animate={{ y: 0 }}
