      ...
      <main>
        <div className="bg-[#090A0B] overflow-x-hidden relative min-h-[800px] 4xl:min-h-[1500px] 3xl:min-h-[1200px] xl:min-h-[850px]">
          <div className="px-12 pb-20 relative z-30">
            <div className="h-full w-full m-auto mt-48 lg:mt-64 max-w-7xl 3xl:max-w-8xl 3xl:mt-72 3xl:mb-24 xl:mb-20">
              <h1 className="text-white text-4xl sm:text-5xl 3xl:text-6xl text-left font-bold max-w-xl 3xl:max-w-2xl uppercase tracking-wider">
                Battery Energy Storage System
              </h1>
              <p className="text-white/60 font-geist text-[1.45rem] 3xl:text-[1.5rem] mt-3 3xl:mt-6">
            ...
            <div className="flex mt-12 mx-auto max-w-7xl 3xl:max-w-8xl justify-between flex-wrap">
              <div className="py-8">
                ...
                <p className="text-white text-[2.5rem] 3xl:text-[3.25rem] font-semibold leading-[1.2] my-3 max-w-[15rem]">
                  Safety by design
                </p>
                <p className="text-white/60 font-geist max-w-xs text-xl 3xl:text-2xl">
              ...
              <div className="py-8">
                ...
                <p className="text-white text-[2.5rem] 3xl:text-[3.25rem] font-semibold leading-[1.2] my-3 max-w-[17rem]">
                  Future-proof design
                </p>
                <p className="text-white/60 font-geist max-w-xs text-xl 3xl:text-2xl">
