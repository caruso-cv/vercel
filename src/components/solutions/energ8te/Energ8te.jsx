...
import Bullets from "@/components/solutions/energ8te/Energ8teBullet";
  ...
  return (
    <div className="relative min-h-screen">
      <section>
        ...
        <h1 className="max-w-8xl mx-auto px-6 2xl:px-0 pt-36 lg:pt-52 relative z-30" role="img" aria-label="ENERG8TE™ BMS Controller for Energy Storage">
          <ENERG8TE className="h-16 sm:h-28 3xl:h-32" />
        </h1>
              ...
              <div className="text-left pt-12 xl:pt-0 ">
                ...
                <div className="mt-10 flex gap-6 relative flex-col 4sm:flex-row items-start">
                  <a
                    ...
                    alt="ENERG8TE™ BMS Controller for Energy Storage Product Brief"
                    target="_blank"
      ...
      <section className="max-w-8xl w-full mx-auto text-black pt-20 lg:pt-24 pb-20 px-6 2xl:px-0" aria-labelledby="specs-heading">
        ...
        <div className="border-2 border-[#2F79F8] rounded-md overflow-hidden">
          <div className="grid grid-cols-1">
            {/* DIMENSIONS */}
            <h3 className="p-4 lg:p-6 pb-0 md:pb-4 md:border-b md:border-b-gray-200 border-[#2F79F8] font-semibold xs:text-xl 3xl:text-[22.4px] ">
