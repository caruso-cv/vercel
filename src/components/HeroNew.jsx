      ...
      <div className="mx-auto max-w-8xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl shrink-0 lg:mx-0 lg:pt-8">
          ...
          <div className="mt-24 sm:mt-32 lg:mt-16 opacity-70">
            <span className="rounded-full bg-gradient-to-r from-[#121212]/70 to-[#232323]/70 px-6 py-3 text-xl font-medium text-white ">
          ...
          <div className="mt-14 flex items-center gap-x-6">
            <Link   href="#get-started"
                ...
                <motion.div className="hidden lg:inline-flex items-center justify-center py-5 px-2.5 md:px-3.5 text-xl font-bold tracking-[0.2px] cursor-pointer border-none rounded-[5px] transition-colors duration-200 ease-in-out bg-[#E6E6E6] hover:bg-[#FFF] shadow-md opacity-90 hover:opacity-100 text-black">
