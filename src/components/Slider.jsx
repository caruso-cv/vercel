...
const slidesData = [
  ...
  },
  {
    ...
    desktop: {
      ...
      bodyTextBeforeSpan: "We produce ",
      bodyTextSpan: "a point tester called ECU8TR™",
      bodyTextAfterSpan:
        "  that ensures communication and individual cell health within battery modules. Compatible with ISO SPI and ISO UART.",
